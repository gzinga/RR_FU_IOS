...
namespace FUCounter_App
{
	...
	partial class FUCounter_AppViewController
	{
		...
		[Action ("F1AllBox:")]
		[GeneratedCode ("iOS Designer", "1.0")]
		partial void F1AllBox (UITextField sender);

		[Action ("F1Box:")]
		[GeneratedCode ("iOS Designer", "1.0")]
		partial void F1Box (UITextField sender);

		[Action ("F2AllBox:")]
		[GeneratedCode ("iOS Designer", "1.0")]
		partial void F2AllBox (UITextField sender);

		[Action ("F2Box:")]
		[GeneratedCode ("iOS Designer", "1.0")]
		partial void F2Box (UITextField sender);

		[Action ("F3AllBox:")]
		[GeneratedCode ("iOS Designer", "1.0")]
		partial void F3AllBox (UITextField sender);

		[Action ("F3Box:")]
		[GeneratedCode ("iOS Designer", "1.0")]
		partial void F3Box (UITextField sender);

		[Action ("F4Box:")]
		[GeneratedCode ("iOS Designer", "1.0")]
		partial void F4Box (UITextField sender);
